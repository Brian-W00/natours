...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnJpYW53ZWkiLCJhIjoiY20xaW02ZjdrMHFvazJpcHFzZWlyMmk4aCJ9.K-_q1P8t3zrNDcMC40mZAA';
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.stats = 'success') location.reload(true);
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " udpated successgully!"));
          }
          _context.next = 11;
          break;
        case 8:
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51Q46vvP6OJpOhzrty7EmMdEWlkl08DFU6LuvwWPM9TPRNCTXCowdCCASA6RCiYZqiuD6VhtJygPMylZh301h0JXW004htoPcFA');
          _context.prev = 1;
          _context.next = 4;
